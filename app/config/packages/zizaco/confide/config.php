...
return array(
    ...
    */
    ...
    |
    */
    'login_form' =>             'shared.partials.user.login',
    'signup_form' =>            'shared.partials.user.signup',
    'forgot_password_form' =>   'shared.partials.user.forgot_password',
    'reset_password_form' =>    'shared.partials.user.reset_password',
